...
public class mainV {   
    public static void main(String[] args) throws CloneNotSupportedException{
        ...
        artigos artS = new artigos(A, false, 1, "sapatilhas fixes", "Nike", 19.99, amazon);

        tshirts B = new tshirts(Tamanho.M, Padroes.Liso);
        artigos artT = new artigos(B, true, 0, "T-Shirt fixe", "Tiffosi", 9.99, amazon);

        malas C = new malas(true, 30, 32, "Policarbonato", 2008);
        artigos artM = new artigos(C, false, 2, "Mala fixe", "Samsonite", 49.99, UPS);

        sapatilhas D = new sapatilhas(true, 35, true,"rosa", 2012);
        artigos artS2 = new artigos(D, false, 3, "sapatilhas rosinhas", "Adidas", 60.00, DHL);

        tshirts E = new tshirts(Tamanho.L,Padroes.Palmeiras);
        artigos artT2 =new artigos(E, false, 1, "Palmeiras bonitas", "Gucci", 35.99, UPS);

        malas F = new malas(true,20,15,"Plastico", 2019);
        artigos artM2 = new artigos(F, true, 0, "Nunca usada, e muito incrivel", "Prada", 1300.94, DHL);

        sapatilhas G = new sapatilhas(false, 39, true, "preto", 2022);
        artigos artS3 = new artigos(G, false, 1, "O preto é um bom contraste com o branco", "Veja", 50.99, amazon);

        tshirts H = new tshirts(Tamanho.XL,Padroes.Riscas);
        artigos artT3 = new artigos(H, false, 1, "Tshirt rosinha com um unicornio", "Brand Melvin", 18.99, DHL);

        malas I = new malas(false,50,59,"ganga",2023);
        artigos artM3 = new artigos(I, true, 0, "Novinho e stylish", "parfois", 40.60, amazon);

        sapatilhas J = new sapatilhas(true, 37, true, "branco", 2020);
        artigos artS4 = new artigos(J, true, 0, "Sapatilhas branquinhas sem nenhuma mancha", "Bufallo", 170.99, UPS);

        tshirts K = new tshirts(Tamanho.S,Padroes.Liso);
        artigos artT4 =new artigos(K, false, 12, "Perfeita tshirt para uma criança", "Adidas", 12.99, UPS);

        malas L = new malas(true, 25,29,"ABS", 2019);
        artigos artM4 = new artigos(L, false, 2, "Mala dourada perfeita para sair de casa", "Giorgio Armani", 570.99, DHL);
